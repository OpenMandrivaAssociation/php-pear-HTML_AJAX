...
install -d %{buildroot}%{_datadir}/pear/%{_class}/%{_subclass}/Serializer
install -d %{buildroot}%{_datadir}/pear/%{_class}/js
    
install %{_pearname}-%{version}/*.php %{buildroot}%{_datadir}/pear/%{_class}/
install %{_pearname}-%{version}/%{_subclass}/*.php %{buildroot}%{_datadir}/pear/%{_class}/%{_subclass}/
install %{_pearname}-%{version}/%{_subclass}/Serializer/*.php %{buildroot}%{_datadir}/pear/%{_class}/%{_subclass}/Serializer/
install %{_pearname}-%{version}/js/*.js %{buildroot}%{_datadir}/pear/%{_class}/js/
...
%{_datadir}/pear/%{_class}/%{_subclass}/Serializer/*.php
%{_datadir}/pear/%{_class}/%{_subclass}/*.php
%{_datadir}/pear/%{_class}/*.php
%{_datadir}/pear/%{_class}/js/*.js
